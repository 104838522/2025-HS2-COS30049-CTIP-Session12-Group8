...
joblib.dump(rf_reg, "./models/rf_model.joblib")
print("Saved rf_scaler.joblib & rf_model.joblib inside backend/models")

src_vec = "./vectorizer.pkl"
dst_vec = "./models/vectorizer.joblib"

if os.path.exists(dst_vec):
    print("vectorizer.joblib already exists in backend/models. Skipping copy")
